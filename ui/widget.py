...
class Button(Widget):
    ...
    def __init__(self, x, y, width, height):
        ...
        self.text = ""
        self.text_surface = Button.text_font.render(self.text, False, (232, 232, 232), self.color)

        self.display_tooltip = False
        self.tip_text = ""
        self.tip_text_surface = Button.text_font.render(self.tip_text, False, (232, 232, 232), (0, 0, 0))
    ...
    def render(self, display=pygame.display.get_surface()):
        ...
        display.blit(self.surf, self.rect)
        self.text_surface = Button.text_font.render(self.text, False, (232, 232, 232), new_color)
...
class Player(Widget):
    ...
    def __init__(self):
        ...
        self.health_icon = pygame.transform.scale(self.health_icon, (self.health_icon.get_width() * 2.0, self.health_icon.get_height() * 2.0))

        self.money_icon = pygame.image.load("assets/tiles/pngs/money.png")
        self.money_icon = pygame.transform.scale(self.money_icon, (self.money_icon.get_width() * 2.0, self.money_icon.get_height() * 2.0))

    def update(self, dt):
        pass
    def render(self, display):
        health_text = Button.text_font.render(str(self.health), False, (232, 18, 18), (0, 0, 0))
        money_text = Button.text_font.render(str(self.money), False, (180, 180, 18), (0, 0, 0))
